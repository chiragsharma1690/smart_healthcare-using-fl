...
# len_per_iteration = 10  # using equal size datasets for each client in this example
len_per_iteration = 60

LENS_PER_ITERATION = {client_name: len_per_iteration for client_name in client_names}

# LEN_TEST: Length of test dataset. Note whole dataset length is 166
# LEN_TEST = 16
LEN_TEST = 400
